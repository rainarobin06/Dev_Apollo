...
namespace Apollo.Web.NursingApp.Models
{
    public class ProcessImprovement
    {
        ...
        public string CriticalLabValue { get; set; }
        public string BloodTransfusion { get; set; }
        public string POCT { get; set; }
        public string ClinicalHandOff { get; set; }
        public string ComplianceMedicationErrors { get; set; }
        public string ComplianceBloodSugar { get; set; }
        public string ReasonsNotAchieve { get; set; }
